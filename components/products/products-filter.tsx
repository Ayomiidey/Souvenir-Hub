    ...
    <div className="space-y-6 bg-white dark:bg-slate-900 border border-gray-200 shadow-sm rounded-lg">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <Filter className="h-5 w-5 mt-3 ml-5 text-primary" />
          <h2 className="text-xl font-bold mt-3 bg-gradient-to-r from-gray-900 to-gray-600 bg-clip-text text-transparent dark:from-white dark:to-gray-300 font-[Inter]">
            Filters
          </h2>
