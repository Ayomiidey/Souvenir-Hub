...
export function Header() {
  ...
  return (
    <header className="fixed top-0 z-50 w-full border-b bg-white/80 backdrop-blur-md supports-[backdrop-filter]:bg-white/80 dark:bg-slate-900/80 dark:supports-[backdrop-filter]:bg-slate-900/80 shadow-sm">
